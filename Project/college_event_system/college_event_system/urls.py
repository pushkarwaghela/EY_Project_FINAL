...
urlpatterns = [
    ...
    path('manage/generate-qr/', views.admin_generate_qr, name='generate_qr'),
    path('manage/generate-qr/<str:event_id>/', views.generate_event_qr, name='generate_event_qr'),
    path('manage/attendance/toggle-verification/<str:attendance_id>/', 
         views.toggle_attendance_verification, name='toggle_attendance_verification'),
    path('manage/attendance/update/<str:attendance_id>/', 
         views.update_attendance, name='update_attendance'),
    path('manage/attendance/delete/<str:attendance_id>/', 
